...
| renderer           | snapshot 복사본, 로그인 버튼·capture UI·OCR resource                                                                                                                | 패스키 로그인·복구 의도. 로그인 성공·권한·URL·token을 제출하지 않음                 |
