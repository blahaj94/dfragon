...
```sh
pnpm --filter @ldb/desktop exec vitest run scripts/auth-capture-fixture src/backend/capture src/backend/main.test.ts src/frontend/src/sections/auth src/frontend/src/sections/capture src/frontend/src/App.test.tsx src/frontend/src/App.capture-controls.test.tsx
