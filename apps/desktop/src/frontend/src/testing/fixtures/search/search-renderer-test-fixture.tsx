...
vi.mock('../../../features/capture/lib/ocr', async (original) => ({
  ...(await original<typeof import('../../../features/capture/lib/ocr')>()),
  createPartyOcrWorker: media.worker
}))
vi.mock('../../../features/capture/utils/party', async (original) => ({
  ...(await original<typeof import('../../../features/capture/utils/party')>()),
  capturePartyNicknameCrops: media.crops
}))
vi.mock('../../../features/capture/utils/recognition', async (original) => ({
  ...(await original<typeof import('../../../features/capture/utils/recognition')>()),
