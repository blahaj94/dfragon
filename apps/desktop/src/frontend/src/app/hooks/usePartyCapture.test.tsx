...
vi.mock('../../features/capture/lib/ocr', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../features/capture/lib/ocr')>()),
  createPartyOcrWorker: moduleMocks.createPartyOcrWorker
}))

vi.mock('../../features/capture/utils/party', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../features/capture/utils/party')>()),
  capturePartyNicknameCrops: moduleMocks.capturePartyNicknameCrops
}))

vi.mock('../../features/capture/utils/recognition', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../features/capture/utils/recognition')>()),
